# Appendix A: Sunshine App Steps

This section details the key tasks done in each step of building the Sunshine App (for quick reference in review sessions).

Code Solutions currently linked to Udacity's own GitHub repo.

**TODOS**
* link to version working with Android Studio 1.0, API 21 setting)
* add 1 sentence per code commit with learnings/goals for that step
* add screenshot of app as relevant to the completed step
...
### Lesson 5: Content Providers & Loaders
...
### Lesson 7: Services & Notification
